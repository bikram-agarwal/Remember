...
fun ViewOptionsSheet(
    ...
    AppBottomSheet(
        ...
        onDismiss = onDismiss,
        actions = {
            TextButton(onClick = { onChange(ViewOptions()) }) { Text("Reset") }
        ...
        Row(
            ...
            FilledTonalIconButton(
                ...
                Icon(
                    if (viewOptions.sortDir == SortDir.DESC) Icons.Filled.ArrowDownward
                    else Icons.Filled.ArrowUpward,
                    contentDescription = if (viewOptions.sortDir == SortDir.DESC) "Descending" else "Ascending",
                )
            }
        }
