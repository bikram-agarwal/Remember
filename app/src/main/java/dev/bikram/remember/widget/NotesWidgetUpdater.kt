    ...
    constructor(
        ...
        private suspend fun performRefresh() {
            runCatching {
                ...
                val starredIds = widgetIds(appWidgetManager, StarredWidgetReceiver::class.java)
                NotesWidget().updateAll(context)
                QuickCaptureWidget().updateAll(context)
                StarredWidget().updateAll(context)
                ...
                requestProviderUpdate(StarredWidgetReceiver::class.java, starredIds)
            }.onFailure { throwable ->
