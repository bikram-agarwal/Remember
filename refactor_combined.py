...
def process_file(filepath):
    ...
    # Replace .combinedClickable( with .tapSoundCombinedClickable(
    if '.combinedClickable(' in content:
        content = content.replace('.combinedClickable(', '.tapSoundCombinedClickable(')
        
        # Add import if not exists
        if 'import dev.bikram.remember.ui.feedback.tapSoundCombinedClickable' not in content:
            ...
            if import_idx != -1:
                ...
                if pkg_idx != -1:
                    imports_str = 'import dev.bikram.remember.ui.feedback.tapSoundCombinedClickable\n'
